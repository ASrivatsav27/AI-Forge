export declare const functions: import("inngest").InngestFunction<import("inngest").InngestFunction.Options<[{
    readonly event: "project/setup.requested";
}], ({ event, error, }: Omit<{
    ...
    event: {
        ...
        meta?: import("inngest").ReceivedEventMeta;
        ts: number;
        v: string;
    } | {
        data: {
    ...
    jobId?: string;
    step: {
        sendEvent: (idOrOptions: import("inngest").StepOptionsOrId, payload: import("inngest").SendEventPayload) => Promise<import("inngest/types").SendEventOutput<import("inngest").ClientOptionsFromInngest<import("inngest").Inngest<{
            readonly id: "AI-Forge";
        }>>>>;
        ...
        sendSignal: (idOrOptions: import("inngest").StepOptionsOrId, opts: {
            signal: string;
            data?: unknown;
        }) => Promise<import("inngest").SendSignalResponse>;
        waitForEvent: <TOpts extends {
            ...
            event: import("inngest").EventType<infer TName extends string, import("better-auth").StandardSchemaV1<infer TData extends Record<string, unknown>>>;
        } ? {
            name: TName;
            data: TData;
            id: string;
            ...
            schema: import("better-auth").StandardSchemaV1<infer TData_1 extends Record<string, unknown>>;
        } ? {
            name: TName_2;
            data: TData_1;
            id: string;
    ...
    attempt: number;
    maxAttempts?: number;
}, "step" | keyof import("inngest").FailureEventArgs<import("inngest").EventPayload<any>>> & import("inngest").FailureEventArgs<import("inngest").EventPayload<any>> & {
    step: {
        sendEvent: (idOrOptions: import("inngest").StepOptionsOrId, payload: import("inngest").SendEventPayload) => Promise<import("inngest/types").SendEventOutput<import("inngest").ClientOptionsFromInngest<import("inngest").Inngest<{
            readonly id: "AI-Forge";
        }>>>>;
...
}) => Promise<import("inngest/types").JsonifyObject<{
    success: boolean;
    reason: string;
...
}) => Promise<void>, import("inngest").Inngest<{
    readonly id: "AI-Forge";
}>, [{
    readonly event: "project/setup.requested";
}]>[];
